...
<?php
	...
	$retrieve_query = mysqli_query($connections,"SELECT * FROM requestertbl WHERE stat='0' ORDER BY rollNo DESC ");
		...
		<div class="modal_content">
			<div class="close" onclick="closeB()" style="cursor:pointer;">X</div>
				<form method="POST">
				            ...
				            <font style="text-shadow:0 2px 1px #fff, 0 -2px 1px #fff, 2px 0 1px #fff, -2px 0 1px #fff;" color="black"><b><?php echo "Do you want to unarchive "?></br><font style="text-shadow:0 2px 1px #fff, 0 -2px 1px #fff, 2px 0 1px #fff, -2px 0 1px #fff;" size="5em" color="red"><?php echo $db_Requester;?></font><?php echo " ?"; ?></b></font>
